...
public class CoverageMain {
    ...
    public static void main(String[] args) throws Exception {
        ...
        writeToJson(ModuleCoverage.getInstance(), jsonTmpSummaryPath);
    }

    private static void writeToJson(ModuleCoverage moduleCoverage, Path tmpJsonPath) throws IOException {
