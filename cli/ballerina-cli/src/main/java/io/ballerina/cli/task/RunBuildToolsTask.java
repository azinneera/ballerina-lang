...
public class RunBuildToolsTask implements Task {
    ...
    public void execute(Workspace workspace) {
        for (ResolvedPackageDependency packageDependency : workspace.dependencyGraph().toTopologicallySortedList()) {
            ...
            // Reload the project to load the code generated by the build tools
            reloadPackage(workspace, packageDependency.packageId());
        }
    }
    ...
    private void reloadPackage(Workspace workspace, PackageId packageId) {
        ...
        workspace.modify().removePackage(packageId).apply();
        workspace.modify().addPackage(packageConfig).apply();
    }
